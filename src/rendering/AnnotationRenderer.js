/**
 * @fileoverview Renderer for interactive annotation overlays such as crosshairs and labels.
 * This is the canonical location for SVG point annotations, extracted from SvgPlottingService.
 *
 ...
 * @type {Class}
 *
 * @requires None (pure DOM operations)
 *
 * @function clearSvg - Remove all children from an SVG element
 * @function createSvgElement - Factory for SVG DOM elements
 * @function plotPoint - Render a crosshair annotation at a coordinate
 *
 * @exports AnnotationRenderer
 *
 * @example
 * import { AnnotationRenderer } from '@siimpl/graph-it-core';
 * AnnotationRenderer.plotPoint(svgElement, pixelCoords, userInput, parsedData);
 *
 * @relatedFiles SvgPlottingService.js (deprecated), usePlotting.js
 */
